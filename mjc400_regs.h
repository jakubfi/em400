...
// -----------------------------------------------------------------------
// IR
#define IR_OP	((IR & 0b1111110000000000) >> 10)
#define IR_D	((IR & 0b0000001000000000) >> 9)
#define IR_A	((IR & 0b0000000111000000) >> 6)
#define IR_B	((IR & 0b0000000000111000) >> 3)
#define IR_C	((IR & 0b0000000000000111) >> 0)
#define IR_T	((int8_t) (IR & 0b0000000000111111) | ((IR & 0b0000001000000000) >> 2))
#define IR_b	(IR & 0b0000000011111111)
