...
#define CFG_DEFAULT_CPU_IO_USER_ILLEGAL 0
#define CFG_DEFAULT_CPU_STOP_ON_NOMEM 1
#define CFG_DEFAULT_CPU_SPEED_REAL 1
#define CFG_DEFAULT_CPU_EMULATION_QUANTUM_US 100
#define CFG_DEFAULT_CPU_CLOCK_PERIOD_MS 10

#define CFG_DEFAULT_MEMORY_ELWRO_MODULES 1
...
#define CFG_DEFAULT_SOUND_ENABLED 1
#define CFG_DEFAULT_SOUND_BACKEND "auto"
#define CFG_DEFAULT_SOUND_DEVICE NULL
#define CFG_DEFAULT_SOUND_VOLUME 15
#define CFG_DEFAULT_SOUND_RATE 48000
