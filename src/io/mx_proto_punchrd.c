...
// -----------------------------------------------------------------------
int mx_proto_punchrd_conf(struct mx_line *line, uint16_t *data)
{
...
// -----------------------------------------------------------------------
void mx_proto_punchrd_free(struct mx_line *line)
{
...
// -----------------------------------------------------------------------
int mx_proto_punchrd_phy_types[] = { MX_PHY_USART_ASYNC, MX_PHY_8255, -1 };

struct mx_proto mx_proto_punchrd = {
	.enabled = 1,
	.name = "punched tape reader",
	.dir = MX_DIR_INPUT,
	.phy_types = mx_proto_punchrd_phy_types,
