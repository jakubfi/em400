...
#define T_AWT "r%A += %T"
#define T_TRB "r%A += %T\n\tif (r%A == 0) then skip"
#define T_IRB "r%A++\n\tif (r%A != 0) then IC += %T (=%R)"
#define T_DRB "r%A--\n\tif (r%A != 0) then IC += %T (=%R)"
#define T_CWT "r%A ?? %T"
#define T_LWT "r%A = %T"
#define T_LWS "r%A = [IC+%T (=%R)]"
#define T_RWS "[IC+%T (=%R)] = r%A"
...
#define T_UJS "IC += %T (=%R)"
#define T_JLS "if < then IC += %T (=%R)"
#define T_JES "if == then IC += %T (=%R)"
#define T_JGS "if > then IC += %T (=%R)"
#define T_JVS "if V then IC += %T (=%R)\n\tV = 0"
#define T_JXS "if X then IC += %T (=%R)"
#define T_JYS "if Y then IC += %T (=%R)"
#define T_JCS "if C then IC += %T (=%R)"
