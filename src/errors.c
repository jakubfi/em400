...
struct _em400_errordesc {
	...
	{ E_IO_DEV_UNKNOWN, "unknown device type or device incompatibile with channel" },
	{ E_IO_CHAN_INIT, "cannot initialize channel" },
	{ E_IO_DEV_INIT, "cannot initialize device" },
	{ E_IO_DEV_INIT_ARGS, "error parsing device arguments" },
