...
{
	LOG(L_PNRD, 10, "MULTIX/punchreader (line:%i): configure physical line", unit->phy_num);
	return E_OK;
}
...
{
	LOG(L_PNRD, 10, "MULTIX/punchreader (line:%i): configure logical line", unit->phy_num);
	return E_OK;
}
...
{
	LOG(L_PNRD, 10, "MULTIX/punchreader (line:%i): attach", unit->log_num);
	unit->attached = 1;
...
{
	LOG(L_PNRD, 10, "MULTIX/punchreader (line:%i): detach", unit->log_num);
	unit->attached = 0;
...
{
	LOG(L_PNRD, 10, "MULTIX/punchreader (line:%i): status", unit->log_num);
	return 0;
}
