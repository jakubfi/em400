...
commands:
	.word	KZ_CMD_CTL1, KZ_CMD_CTL2, KZ_CMD_CTL3, KZ_CMD_CTL4
	.word	KZ_CMD_CTL1, KZ_CMD_CTL1
	.word	KZ_CMD_CTL2, KZ_CMD_CTL2
	.word	KZ_CMD_CTL3, KZ_CMD_CTL3
	.word	KZ_CMD_CTL4, KZ_CMD_CTL4
	.word	KZ_CMD_CTL1, KZ_CMD_CTL1
	.word	0
