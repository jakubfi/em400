...
struct mx_proto mx_proto_floppy = {
	...
	.task = {
		...
		[MX_TASK_TRANSMIT] = { 4, 4, 3, { mx_proto_floppy_transmit_start, NULL, NULL, NULL, NULL, NULL, NULL, NULL } },
		[MX_TASK_ABORT] = { 0, 0, 0, { NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL } },
		[MX_TASK_ATTACH] = { 3, 0, 0, { mx_proto_attach_start, NULL, NULL, NULL, NULL, NULL, NULL, NULL } },
	}
};
