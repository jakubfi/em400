...
{
	LOG(L_PNCH, 2, "MULTIX/puncher (line:%i): configure physical line", unit->phy_num);
	return E_OK;
}
...
{
	LOG(L_PNCH, 2, "MULTIX/puncher (line:%i): configure logical line", unit->phy_num);
	return E_OK;
}
...
{
	LOG(L_PNCH, 2, "MULTIX/puncher (line:%i): attach", unit->log_num);
	unit->attached = 1;
...
{
	LOG(L_PNCH, 2, "MULTIX/puncher (line:%i): detach", unit->log_num);
	unit->attached = 0;
...
{
	LOG(L_PNCH, 2, "MULTIX/puncher (line:%i): status", unit->log_num);
	return 0;
}
